    ...
    return (
        <div className="container mx-auto py-8 space-y-6">
            <div>
                ...
                <p className="text-muted-foreground">Manage your account, subscriptions, and preferences</p>
            </div>
                    ...
                    <Card>
                        <CardHeader>
                            <div className="flex items-center justify-between">
                                ...
                                <Button variant="default" onClick={() => setIsUpgradePlanModalOpen(true)}>
                                    Upgrade Plan
                                </Button>
                            </div>
                        </CardHeader>
                            ...
                            <div className="bg-muted p-6 rounded-lg mb-6">
                                <div className="flex justify-between items-start">
                                    <div>
                                        ...
                                        <p className="text-muted-foreground mb-2">Start building better habits with real money stakes.</p>
                                        <ul className="space-y-1 text-sm">
                                            <li className="flex items-center">
                                                <span className="mr-2 text-primary">✓</span> Unlimited Habits
                                            </li>
                                            <li className="flex items-center">
                                                <span className="mr-2 text-primary">✓</span> Basic Insights (Progress Charts)
                                            </li>
                                            <li className="flex items-center">
                                                <span className="mr-2 text-primary">✓</span> Minimum Stake: $5 per habit
                                            </li>
                                        </ul>
                                    </div>
